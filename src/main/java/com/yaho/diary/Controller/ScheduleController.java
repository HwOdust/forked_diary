...
import com.yaho.diary.Entity.FixedSkip; // ✨ 추가
...
public class ScheduleController {
    ...
    public ResponseEntity<Map<String, Object>> getTimelineData() {
        ...
        data.put("skippedFixedKeys", skippedFixedKeys); // ✨ 추가
    ...
    // ✨ 신규 구현: 오늘 일정에서 빼기(루틴 Skip) 연동 API 엔드포인트
    ...
    // ... 아래 기존 오리지널 로직들(updateSchedule, deleteSchedule 등)은 그대로 유지됩니다.
    @PutMapping("/update")
